...
public class GetRestData {
    ...
    private static final String urlAPI = "https://financialmodelingprep.com/api/v3";
    private static final String keyAPI = "efffd6f379b321e3b885925577bee979";

    public String fetchDataFromFinancialModelingPrep(String symbol, String field) throws Exception {
        String url = urlAPI + "/quote/" + symbol + "?apikey=" + keyAPI;
